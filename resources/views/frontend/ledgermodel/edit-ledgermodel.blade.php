          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
               ...
               <div class="card-header">
                <h3>Add ledger
                	...
                	<a class="btn btn-primary float-right" href=" {{route('ledgermodel.viewer')}} "><i class="fa fa-user-circle"></i>  ledger list</a>
              ...
              <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('ledgermodel.update',$editData->id) }}" id="myform" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
