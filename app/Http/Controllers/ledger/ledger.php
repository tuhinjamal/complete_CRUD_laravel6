...
class ledger extends Controller
{
    ...
    public function summary()
    {
        ...
        $sum2= DB::table('ledgermodels')->where('created_by',Auth::user()->id)->sum(\DB::raw('note_payble + account_payble +capital+revenue'));
        return view('frontend.ledgermodel.summary',['sum'=>$sum,'sum2'=>$sum2]);
    }
